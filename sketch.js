 ...
 text("Pontuação:"+ score, 500,50);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon){
    case 1: red_balloon0.addImage("red_balloon0.png");
            break;
    case 2: blue_balloon0.addImage("blue_balloon0.png");
            break;
    case 3: green_balloon0.addImage("green_balloon0.png");
            break;
    case 4: pink_balloon0.addImage("pink_balloon0.png");
            break;
